            ...
            >
              ...
              <div className=" pl-20 pr-4 md:pl-4 w-full h-full">
                ...
                <div className="lg:flex  lg:flex-row flex flex-col relative h-[25rem] ">
                  ...
                  <div className=" lg:w-3/5 md:w-1/2 text-xs lg:text-lg md:text-xs md:p-0 md:px-7 absolute md:top-0 md:right-0 lg:right-0 bottom-0 lg:top-0 px-6 text-white font-regular font-poppins ">
