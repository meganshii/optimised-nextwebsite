...
import seoData from "@/components/Constants/pinkcity/PinkcityPage.json"; // Importing the JSON array
...
export async function generateMetadata(): Promise<Metadata> {
  const metadata: pinkcitySeoData | undefined = seoData?.pinkcitySeoData;
