...
import seoData from "@/components/Constants/ourcompany/OurcompanyPage.json"; // Importing the JSON array
...
export async function generateMetadata(): Promise<Metadata> {
  const metadata: companySeoData | undefined = seoData?.companySeoData;
